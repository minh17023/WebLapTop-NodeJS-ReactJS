                ...
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="flex-1 max-w-xl mx-8 hidden md:block relative" ref={searchRef}>
                        <form onSubmit={handleSearchSubmit} className="relative group">
                            ...
                            />
                            <button type="submit" className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#0071E3] transition-colors">
                    ...
                    <div className="flex items-center space-x-6 flex-shrink-0">
                        <Link to="/cart" className="relative text-[#0a0a0a] hover:text-[#0071E3] transition-colors group">
                            <div className="p-2 rounded-full hover:bg-blue-50 transition-colors">
                                <ShoppingCart size={22} strokeWidth={2.5} />
                            </div>
                            {cartCount > 0 && (
                                <span className="absolute 1 top-0 right-0 bg-[#0071E3] text-white text-[10px] font-black rounded-full h-4 w-4 flex items-center justify-center ring-2 ring-white transform group-hover:scale-110 transition-transform">
                                    {cartCount}
                                </span>
                            )}
                        </Link>
                        ...
                        {user ? (
                            <div className="relative group py-4">
                                <div className="flex items-center space-x-3 cursor-pointer">
                                    <div className="w-9 h-9 rounded-full bg-gray-100 flex items-center justify-center text-[#0a0a0a] border border-gray-200 group-hover:border-[#0071E3] group-hover:text-[#0071E3] transition-colors">
                                ...
                                <div className="absolute right-0 top-full w-56 bg-white rounded-xl shadow-2xl border border-gray-100 py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform origin-top-right group-hover:scale-100 scale-95 z-50">
                                    <Link to="/profile" className="flex items-center px-4 py-2.5 text-sm font-medium text-[#0a0a0a] hover:bg-gray-50 hover:text-[#0071E3] transition-colors">
                                        <UserCircle size={18} className="mr-3" /> Thông tin cá nhân
                                    </Link>
                                    <Link to="/my-orders" className="flex items-center px-4 py-2.5 text-sm font-medium text-[#0a0a0a] hover:bg-gray-50 hover:text-[#0071E3] transition-colors">
                                    ...
                                    <div className="border-t border-gray-100 mt-1">
                                        <button onClick={logout} className="w-full flex items-center px-4 py-2.5 text-sm font-bold text-[#0071E3] hover:bg-blue-50 transition-colors">
                            ...
                            <div className="flex items-center space-x-4">
                                <Link to="/login" className="text-sm font-bold text-[#0a0a0a] hover:text-[#0071E3] transition-colors">
                                    Đăng nhập
                                </Link>
                                <Link to="/register" className="text-sm font-bold text-white bg-[#0a0a0a] hover:bg-[#0071E3] px-5 py-2 rounded-full transition-colors shadow-lg shadow-black/10 hover:shadow-blue-500/20">
                                    Đăng ký
                                </Link>
                            </div>
                        )}
            ...
            <div className="bg-gray-50/80 backdrop-blur-md border-b border-gray-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <nav className="flex items-center space-x-8 overflow-x-auto whitespace-nowrap scrollbar-hide">
                        <Link to="/" className="text-gray-600 text-sm font-bold py-4 border-b-2 border-transparent hover:border-[#0071E3] hover:text-[#0071E3] transition-all">
                            Trang Chủ
                        </Link>
                        <Link to="/categories/laptop-gaming" className="text-gray-600 text-sm font-bold py-4 border-b-2 border-transparent hover:border-[#0071E3] hover:text-[#0071E3] transition-all">
                            Laptop Gaming
                        </Link>
                        <Link to="/categories/laptop-van-phong" className="text-gray-600 text-sm font-bold py-4 border-b-2 border-transparent hover:border-[#0071E3] hover:text-[#0071E3] transition-all">
                            Laptop Văn Phòng
                        </Link>
                        <Link to="/categories/macbook" className="text-gray-600 text-sm font-bold py-4 border-b-2 border-transparent hover:border-[#0071E3] hover:text-[#0071E3] transition-all">
                            Apple (MacBook)
                        </Link>
                        <Link to="/products" className="text-gray-600 text-sm font-bold py-4 border-b-2 border-transparent hover:border-[#0071E3] hover:text-[#0071E3] transition-all">
                            Tất Cả Sản Phẩm
                        </Link>
                        <Link to="/posts" className="text-gray-600 text-sm font-bold py-4 border-b-2 border-transparent hover:border-[#0071E3] hover:text-[#0071E3] transition-all">
                            Tin Tức
                        </Link>
                        <Link to="/chinh-sach-bao-hanh" className="text-gray-600 text-sm font-bold py-4 border-b-2 border-transparent hover:border-[#0071E3] hover:text-[#0071E3] transition-all">
                            Chính Sách Bảo Hành
                        </Link>
                    </nav>
                </div>
