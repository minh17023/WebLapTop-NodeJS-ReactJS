    ...
    return (
        <header className="h-16 bg-white border-b border-gray-100 flex items-center justify-between px-8 sticky top-0 z-40 flex-shrink-0">
            ...
            <div>
                ...
                <h2 className="text-sm font-bold text-gray-700">Xin chào, <span className="text-red-600">{user?.full_name || user?.fullName || 'Quản trị viên'}</span> 👋</h2>
            </div>
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button 
                        ...
                        className="flex items-center gap-1.5 text-xs font-bold text-gray-500 hover:text-red-600 bg-gray-50 hover:bg-red-50 px-3 py-2 rounded-xl transition border border-gray-100"
                    >
